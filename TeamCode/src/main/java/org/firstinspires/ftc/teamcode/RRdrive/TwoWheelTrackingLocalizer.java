...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_Y = -2.125; // Y is the strafe direction

    public static double PERPENDICULAR_X = -4.95;
    public static double PERPENDICULAR_Y = 2.625;

    public static double X_MULTIPLIER = 0.974; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.974; // Multiplier in the Y direction
